...
var tdOfTable = document.getElementsByTagName("td");
//前后按钮
...
/*Code Here*/
function animate (setOfImg) {
    banner.style.transition = "0.5s";
    banner.style.left = -parseInt(setOfImg)*index + "px";
}
...
/*Code Here*/
function buttonOfImg() {
    for (var i = 0;i<spanNode.length;i++){
        spanNode[i].onclick = function () {
            var theIdex = parseInt(this.getAttribute('index'));
            index = theIdex;
            animate(img.offsetWidth);
            showButton();
        }
